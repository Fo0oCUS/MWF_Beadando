        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quizzes_AppUsers_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuizSessionStatus = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizSessions_AppUsers_HostUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionParticipants_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SessionParticipants_QuizSessions_QuizSessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ParticipantAnswers_SessionParticipants_SessionParticipantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParticipantAnswers_SessionParticipantId_QuestionId",
                table: "ParticipantAnswers",
                columns: new[] { "SessionParticipantId", "QuestionId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionParticipants_QuizSessionId_Nickname",
                table: "SessionParticipants",
                columns: new[] { "QuizSessionId", "Nickname" },
                unique: true);
